<template>
    <b-form @submit="submit">
        <b-form-group label-for="place_id" class="my-1">
            ...
            <b-form-input id="place_id" v-model="$v.form_data.place_id.$model" type="text"
        ...
        <b-form-group label-for="place_name_gazetteer" class="my-1">
            ...
            <b-form-input id="place_name_mapping" v-model="$v.form_data.place_name_gazetteer.$model"
                :state="validateState('place_name_gazetteer')" type="text" />
        </b-form-group>
        ...
        <b-form-group label-for="latitude" class="my-1">
            ...
            <b-form-input id="latitude" v-model="$v.form_data.latitude.$model" type="text"
        ...
        <b-form-group label-for="longitude" class="my-1">
            ...
            <b-form-input id="longitude" v-model="$v.form_data.longitude.$model" type="text"
        ...
        <b-form-group label="Is Machine Translation:" label-for="machine_translation" class="my-1">
            <b-form-select id="machine_translation" v-model="$v.form_data.machine_translation.$model"
        ...
        <b-form-group label-for="gazetteer" class="my-1">
            ...
            <b-form-select id="gazetteer" v-model="$v.form_data.gazetteer.$model" :options="lists.gazetteers"
        ...
        <b-form-group label-for="feature_type" class="my-1">
            ...
            <b-form-select id="feature_type" v-model="$v.form_data.feature_type_code.$model"
        ...
        <b-form-group label="* Is Relic:" label-for="is_relic" class="my-1">
            ...
            <b-form-select id="is_relic" v-model="$v.form_data.relic_flag.$model" :options="lists.relic" />
        </b-form-group>
